    ...
    <>
      <div className="grid grid-cols-[minmax(900px, 1fr)] gap-2">
        ...
        <section className="hidden w-auto sm:col-start-2 sm:flex sm:justify-between">
          ...
          <a className="hover:text-[#e9ab53]" href="#new">
            New
          </a>
          <a className="hover:text-[#e9ab53]" href="#popular">
            Popular
          </a>
          <a className="hover:text-[#e9ab53]" href="#categories">
            Trending
          </a>
          <a className="hover:text-[#e9ab53]" href="#categories">
            Categories
        ...
        <section className="sm:hidden px-6 py-2 col-start-2 bg-white self-center justify-self-end absolute top-2 w-3/4">
          {toggleMenu ? (
            <svg
              width="32"
              height="31"
              xmlns="http://www.w3.org/2000/svg"
              className="hover:cursor-pointer justify-start absolute right-2 top-6"
            ...
            <svg
              ...
              height="17"
              xmlns="http://www.w3.org/2000/svg"
              className="hover:cursor-pointer absolute right-2 top-6"
          ...
          {toggleMenu && (
            <div className="h-screen mt-24">
              <a className=" block hover:text-[#e9ab53] py-4" href="/">
                Home
              </a>
              <a className="block hover:text-[#e9ab53] py-4" href="#new">
                New
              </a>
              <a className="block hover:text-[#e9ab53] py-4" href="#popular">
                Popular
              </a>
              <a className="block hover:text-[#e9ab53] py-4" href="#trend">
                Trending
              </a>
              <a className="block hover:text-[#e9ab53] py-4" href="#categories">
                Categories
              </a>
            </div>
          )}
